          ...
          <div class="home-tab">
            <div class="tab-content tab-content-basic">
              <div class="tab-pane fade show active" id="content" role="tabpanel" aria-labelledby="content"> 
                <div class="row">
                    <h2 class='d-flex align-items-center'><i class="mdi mdi-pencil"></i> Writing Test</h2>
                        ...
                        <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('admin.create.mocktest')}}">
                            ...
                            <div class='d-flex col-md-12 flex-row align-items-center justify-content-between'>
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" class="form-control" id="exampleInputUsername1" name="module" value='Writing' readonly> --}}
                                    <select class="select form-control" name="module" style="color: #222" id="inputGroupSelect01">
                                        <option selected value="Writing Task 1">Writing Task 1</option>
                            ...
                            <div class="form-group">
                              <label for="exampleInputEmail1">Upload Sample Answer</label>
