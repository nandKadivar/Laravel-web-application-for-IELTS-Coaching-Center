                      ...
                      <tbody>
                        ...
                        <div class="modal fade bd-example-modal" id="editModal{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{$i->id}}" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="deleteModalLabel">Reading Test</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                      ...
                                      <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('admin.update.mocktest')}}">
                                        ...
                                        <div class='d-flex col-md-12 flex-row align-items-center justify-content-between'>
                                          ...
                                          <div class="form-group">
                                              <label for="exampleInputUsername1">Module</label>
                                              {{-- <input type="text" class="form-control" id="exampleInputUsername1" name='module' value='listening' hidden> --}}
                                              <input type="text" class="form-control" id="exampleInputUsername1" name="module" value='{{$i->ielts_module}}' readonly>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputUsername1">Description</label>
              ...
              <div class="tab-pane fade show" id="wt1" role="tabpanel" aria-labelledby="wt1">
                  ...
                  <div class="row">
                    <table id="example3" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        @foreach($WritingTask1TestList as $i)
                        <tr>
                          <td>{{$i->id}}</td>
                          <td>{{$i->ielts_module}}</td>
                          <td>{{$i->test_desciption}}</td>
                          <td>
                            <a href="{{asset($i->test_paper)}}" target="_blank"><i class="mdi mdi-file-image"></i> view</a>
                          </td>
                          <td>
                            <a href="{{asset($i->sample_answer)}}" target="_blank"><i class="mdi mdi-file"></i> view</a>
                          </td>
                          <td>5</td>
                          <td>{{$i->created_at}}</td>
                          <td>{{$i->updated_at}}</td>
                        ...
                        <div class="modal fade bd-example-modal" id="deleteModal{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{$i->id}}" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card" style="box-shadow: 0 0 0; border-radius: 0px">
                                      <div class="card-body">
                                        <h4 class="card-title">Delete Writing Task 1 Test with id</h4>
                                        <p class="card-description">
                                          {{$i->id}}
                                        </p>
                                        <form class="forms-sample" method="post" action="{{route('admin.destroy.mocktest', ['id' => $i->id, 'module' => $i->ielts_module])}}">
                          ...
                          <div class="modal fade bd-example-modal" id="editModal{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{$i->id}}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="deleteModalLabel">Writing Test 1</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                    ...
                                    <div class="card" style="box-shadow: 0 0 0; border-radius: 0px">
                                      <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('admin.update.mocktest')}}">
                                          ...
                                          <div class="form-group">
                                            <label for="exampleInputEmail1">Change Sample Answer</label>
                                            <input type="file" class="form-control" style="background-color: #fff; color: #333" name='sample_answer'>
                                          </div>
                                          {{-- <button type="submit" class="btn btn-primary me-2">Create</button> --}}
                                          @error('paper')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
              ...
              <div class="tab-pane fade show" id="wt2" role="tabpanel" aria-labelledby="wt2">
                ...
                <div class="row">
                  <table id="example4" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @foreach($WritingTask2TestList as $i)
                      <tr>
                        <td>{{$i->id}}</td>
                        <td>{{$i->ielts_module}}</td>
                        <td>{{$i->test_desciption}}</td>
                      ...
                      <div class="modal fade bd-example-modal" id="deleteModal{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{$i->id}}" aria-hidden="true">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="col-md-12 grid-margin stretch-card">
                                  <div class="card" style="box-shadow: 0 0 0; border-radius: 0px">
                                    <div class="card-body">
                                      <h4 class="card-title">Delete Writing Task 2 Test with id</h4>
                                      <p class="card-description">
                                        {{$i->id}}
                                      </p>
                                      <form class="forms-sample" method="post" action="{{route('admin.destroy.mocktest', ['id' => $i->id, 'module' => $i->ielts_module])}}">
                        ...
                        <div class="modal fade bd-example-modal" id="editModal{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{$i->id}}" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="deleteModalLabel">Writing Task 2 Test</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                  ...
                                  <div class="card" style="box-shadow: 0 0 0; border-radius: 0px">
                                    <div class="card-body">
                                      ...
                                      <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('admin.update.mocktest')}}">
                                        ...
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Change Sampel Answer</label>
                                          <input type="file" class="form-control" style="background-color: #fff; color: #333" name='sample_answer'>
                                        </div>
                                        {{-- <button type="submit" class="btn btn-primary me-2">Create</button> --}}
                                        @error('paper')
