...
<head>
  ...
  <!-- plugins:css -->
  <link href="{{asset('vendors/feather/feather.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset('vendors/mdi/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset('vendors/ti-icons/css/themify-icons.css')}}" rel="stylesheet" type="text/css">
  ...
  <link href="{{asset('vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}" rel="stylesheet" type="text/css">
  <link href="{{asset('js/admin/select.dataTables.min.css')}}" rel="stylesheet" type="text/css">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            ...
            <h3 class="welcome-sub-text">Your organization performance summary </h3>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="{{asset('images/logo-mini.svg')}}" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="{{asset('images/logo-mini-reverse.svg')}}" alt="Profile image">
                <p class="mb-1 mt-3 font-weight-semibold">Admin</p>
                <p class="fw-light text-muted mb-0">admin@ielts.com</p>
              </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Online Class</li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('admin.classes')}}" aria-expanded="false" aria-controls="ui-basic">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-radiobox-marked"></i>
              <span class="menu-title">Recording</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('mocktest.create.listening')}}">Listening</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('mocktest.create.reading')}}">Reading</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('mocktest.create.writing')}}">Writing</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Students info</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="" aria-expanded="false" aria-controls="ui-basic">
