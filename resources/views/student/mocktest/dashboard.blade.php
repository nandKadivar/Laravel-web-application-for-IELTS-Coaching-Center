...
@section('content')
    <main class="col-md-12 d-flex flex-column align-center" style="background-color: #f2f2f2; padding: 0px; height: 100vh;">
            ...
            <div class="mock-test-card-container col-md-12" id="r">
                <div class="col-md-11 d-flex flex-wrap flex-row align-items-center justify-content-start">
                    ...
                    <div class="d-flex flex-column align-items-center mock-test-card">
                        ...
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="background-color: #e9ecef; padding: 5px;border-radius: 5px; font-size: 14px;color: #333;">Reading</div>
                        </div>
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="padding: 5px;border-radius: 5px; font-size: 14px; color: #757575; font-weight: 600">Cambridge IELTS 07 Test 3</div>
                        </div>
                        <div class="col-md-12 d-flex flex-column align-items-start justify-content-between pending">
                            <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                                <div style="padding: 5px; font-size: 14px; color: #757575; font-weight: 700">Band</div>
                    ...
                    <div class="d-flex flex-column align-items-center mock-test-card">
                        ...
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="padding: 5px;border-radius: 5px; font-size: 14px; color: #757575; font-weight: 600">Cambridge IELTS 10 Test 1</div>
                        </div>
                        <div class="col-md-12 d-flex flex-column align-items-start justify-content-between">
                            <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                                <div style="padding: 5px; font-size: 14px; color: #757575; font-weight: 700">Band</div>
            ...
            <div class="mock-test-card-container col-md-12" id="w1">
                <div class="col-md-11 d-flex flex-wrap flex-row align-items-center justify-content-start">
                    ...
                    <div class="d-flex flex-column align-items-center mock-test-card">
                        ...
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="background-color: #e9ecef; padding: 5px;border-radius: 5px; font-size: 14px;color: #333;">Writing Task 1</div>
                        </div>
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="padding: 5px;border-radius: 5px; font-size: 14px; color: #757575; font-weight: 600">Cambridge IELTS 14 Test 3</div>
                        </div>
                        <div class="col-md-12 d-flex flex-column align-items-start justify-content-between pending">
                            <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                                <div style="padding: 5px; font-size: 14px; color: #757575; font-weight: 700">Band</div>
                    ...
                    <div class="d-flex flex-column align-items-center mock-test-card">
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="color: #757575; font-weight: 700;">ID: 8558982dba650</div>
                            <i class="mdi mdi-trophy-variant-outline" style="font-size: 24px;"></i>
                        </div>
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="background-color: #e9ecef; padding: 5px;border-radius: 5px; font-size: 14px;color: #333;">Writing Task 1</div>
                        ...
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="padding: 5px;border-radius: 5px; font-size: 14px; color: #757575; font-weight: 600">Cambridge IELTS 15 Test 2</div>
                        </div>
                        <div class="col-md-12 d-flex flex-column align-items-start justify-content-between">
                            <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                                <div style="padding: 5px; font-size: 14px; color: #757575; font-weight: 700">Band</div>
            ...
            <div class="mock-test-card-container col-md-12" id="w2">
                <div class="col-md-11 d-flex flex-wrap flex-row align-items-center justify-content-start">
                    ...
                    <div class="d-flex flex-column align-items-center mock-test-card">
                        ...
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="background-color: #e9ecef; padding: 5px;border-radius: 5px; font-size: 14px;color: #333;">Writing Task 2</div>
                        </div>
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="padding: 5px;border-radius: 5px; font-size: 14px; color: #757575; font-weight: 600">Cambridge IELTS 10 Test 2</div>
                        </div>
                        <div class="col-md-12 d-flex flex-column align-items-start justify-content-between pending">
                            <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                                <div style="padding: 5px; font-size: 14px; color: #757575; font-weight: 700">Band</div>
                    ...
                    <div class="d-flex flex-column align-items-center mock-test-card">
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="color: #757575; font-weight: 700;">ID: 7128985ecc315</div>
                            <i class="mdi mdi-trophy-variant-outline" style="font-size: 24px;"></i>
                        </div>
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="background-color: #e9ecef; padding: 5px;border-radius: 5px; font-size: 14px;color: #333;">Writing Task 2</div>
                        ...
                        <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                            <div style="padding: 5px;border-radius: 5px; font-size: 14px; color: #757575; font-weight: 600">Cambridge IELTS 05 Test 4</div>
                        </div>
                        <div class="col-md-12 d-flex flex-column align-items-start justify-content-between">
                            <div class="col-md-12 d-flex flex-row align-items-center justify-content-between">
                                <div style="padding: 5px; font-size: 14px; color: #757575; font-weight: 700">Band</div>
